<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.php" class="logo">
      ...
      <span class="logo-mini"><b>C</b>FC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CF</b>college</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Chappie</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/extras/invoice.php"><i class="fa fa-circle-o"></i> Invoice</a></li>
            <li><a href="pages/extras/profile.php"><i class="fa fa-circle-o"></i> Profile</a></li>
            <li><a href="pages/extras/login.php"><i class="fa fa-circle-o"></i> Login</a></li>
            <li><a href="pages/extras/register.php"><i class="fa fa-circle-o"></i> Register</a></li>
            <li><a href="pages/extras/lockscreen.php"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
            <li><a href="pages/extras/404.php"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="pages/extras/500.php"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li><a href="pages/extras/blank.php"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="pages/extras/pace.php"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">

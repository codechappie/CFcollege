      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../extras/profile.php"><i class="fa fa-circle-o"></i> Profile</a></li>
            <li><a href="../extras/login.php"><i class="fa fa-circle-o"></i> Login</a></li>
            <li><a href="../extras/register.php"><i class="fa fa-circle-o"></i> Register</a></li>
            <li><a href="../extras/lockscreen.php"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
            <li><a href="../extras/404.php"><i class="fa fa-circle-o"></i> 404 Error</a></li>
            <li><a href="../extras/500.php"><i class="fa fa-circle-o"></i> 500 Error</a></li>
            <li><a href="../extras/blank.php"><i class="fa fa-circle-o"></i> Blank Page</a></li>
            <li><a href="../extras/pace.php"><i class="fa fa-circle-o"></i> Pace Page</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-footer">
          Visit <a href="https://select2.github.io/">Select2 documentation</a> for more extras and information about
          the plugin.
        </div>
      </div>
      <!-- /.box -->
